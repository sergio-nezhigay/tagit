(() => {
  ...
  // extensions/admin-block/src/makeGraphQLQuery.ts
  ...
  // extensions/admin-block/src/orderTagsOperations.ts
  function getOrderTags(orderId) {
    return __async(this, null, function* () {
      ...
      const { data, errors } = yield makeGraphQLQuery(query, variables);
      if (errors) {
  ...
  function updateOrderTags(_0) {
    return __async(this, arguments, function* ({
      ...
      if (currentTags.length > 0) {
        ...
        yield makeGraphQLQuery(mutationRemoveTags, {
          id: orderId,
          tags: currentTags
        });
      }
      ...
      yield makeGraphQLQuery(mutationAddTags, {
        id: orderId,
        tags: [value]
      });
    });
  ...
  // extensions/admin-block/src/stages.ts
  var stages = [
    {
      value: "pending",
      label: "Pending"
  ...
  function App() {
    ...
    const onStageChange = (value2) => __async(this, null, function* () {
      setValue(value2);
      yield updateOrderTags({ value: value2, orderId });
    });
    return loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { blockAlignment: "center", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressIndicator2, { size: "large-100" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(AdminBlock2, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Button2,
        {
          onPress: () => __async(this, null, function* () {
            try {
              const response = yield fetch("/api/proxy-endpoint", {
                method: "POST",
                ...
                // Include this line if you're using POST
              });
              const data2 = yield response.json();
              console.log("Fetch successful:", data2);
            } catch (error) {
