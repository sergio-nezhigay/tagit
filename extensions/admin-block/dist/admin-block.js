(() => {
  ...
  // extensions/admin-block/src/useOrderDetails.ts
  var import_react10 = __toESM(require_react());

  // extensions/admin-block/src/getOrderDetails.ts
  function getOrderDetails(orderId, query) {
    return __async(this, null, function* () {
      ...
      if (errors) {
        throw new Error(
          "Failed to fetch order details: " + errors.map((e) => e.message).join(", ")
        );
      }
      return data == null ? void 0 : data.order;
    });
  }

  // extensions/admin-block/src/useOrderDetails.ts
  function useOrderDetails(data, query) {
    const [orderDetails, setOrderDetails] = (0, import_react10.useState)(null);
    const [error, setError] = (0, import_react10.useState)(null);
    (0, import_react10.useEffect)(() => {
      const fetchAndSetOrderDetails = () => __async(this, null, function* () {
        var _a, _b;
        try {
          if ((_b = (_a = data == null ? void 0 : data.selected) == null ? void 0 : _a[0]) == null ? void 0 : _b.id) {
            const orderId = data.selected[0].id;
            const details = yield getOrderDetails(orderId, query);
  ...
  // extensions/admin-block/src/App.tsx
  ...
  function App() {
    ...
    if (error) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AdminBlock2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
        "Error: ",
        error
      ] }) });
    }
    if (!orderDetails) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(AdminBlock2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Loading order details..." }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
          "Order ID: ",
          ((_b = (_a = data == null ? void 0 : data.selected) == null ? void 0 : _a[0]) == null ? void 0 : _b.id) || "N/A"
        ] })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(AdminBlock2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Order Details:" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: orderDetails })
    ] });
  }
})();
